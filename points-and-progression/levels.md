...
description: >-
  The live level registry binds each cumulative XP threshold to an XP-only
  multiplier, a Daily XP Claim, and a separately calculated balance reward.
---

# Levels

&#x20;A level does not change the Monthly Reward Rate of a staking position.
