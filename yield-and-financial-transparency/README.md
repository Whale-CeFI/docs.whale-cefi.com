...
description: >-
  Whale CeFi recognizes yield only when value has been produced by an approved
  source or released from an already funded budget. A reward promise is a
  liability. A forecast is not funding.
---
...
![Reward-source isolation](../.gitbook/assets/reward-source-isolation.svg)
