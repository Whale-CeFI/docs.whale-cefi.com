...
description: "A displayed rate becomes available for a new position only after the product proves that it has sufficient approved capacity and reward funding for the obligation it is about to accept."
canonical: "https://docs.whale-cefi.com/yield-and-financial-transparency/rates-capacity-and-prefunding"
...
![Rates are reviewed together with capacity and funding](../assets/visuals/diagrams/coverage-limits.svg)
