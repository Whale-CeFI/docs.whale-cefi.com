...
description: >-
  Crypto can feel difficult because several systems are usually compressed into
  a single word. A wallet is not a blockchain. A token symbol is not a complete
  asset identity. A displayed balance is not t
---
...
![The first descent](../.gitbook/assets/02-product-journey.png)
