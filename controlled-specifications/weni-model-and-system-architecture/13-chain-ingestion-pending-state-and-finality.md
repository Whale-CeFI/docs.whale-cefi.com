...
control_id: WENI-13
description: >-
  Ethereum, EVM L2s and additional supported networks expose different
  pending-state, sequencer and finality semantics. WENI normalises them into
  chain-specific evidence without pretending that public m
---
