...
canonical: >-
  https://whale-cefi.com/docs/controlled-specifications/weni/07-domain-corpus-and-continuous-pre-training
document_status: official-release
audience: technical
last_reviewed: '2026-07-29'
control_id: WENI-07
description: >-
  07 Domain adaptation succeeds only when the corpus represents how Web3
  actually fails: proxy upgrades, bytecode patterns, transaction traces,
  liquidity events, exploit families, protocol documents, au
---
