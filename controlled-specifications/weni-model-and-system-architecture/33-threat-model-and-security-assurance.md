...
control_id: WENI-33
description: >-
  WENI’s threat model spans models, data, tools, chain state, contracts, cloud,
  custody, identities, users and insiders. Security assurance maps every control
  to an asset, threat, trust boundary, detect
---
