...
control_id: WENI-24
description: >-
  WENI’s interface is an epistemic instrument: it shows what is known, from
  where, at what state, with what uncertainty, which policy applied and how long
  an action remains valid. The model selects appr
---
