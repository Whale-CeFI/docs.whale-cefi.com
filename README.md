...
### Principal is not revenue or company investment capital

Customer principal, accrued reward liabilities, reward-funding assets, operating revenue, reserves, fees and platform capital occupy separate accounts and control scopes. A customer using an earning or staking plan does not become an equity investor in Whale CeFi merely by opening a position. New customer principal cannot be used to settle an older customer reward.

### A published rate creates an explicit obligation model

Locked-plan rates are bound to a specific product version and accepted before the position opens. Flexible rates can change only prospectively under the notice and effective-time rules stated in the active rate record. Productive strategy yield and company-funded growth support are disclosed as separate economic sources.
